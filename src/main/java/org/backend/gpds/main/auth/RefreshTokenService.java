...
import org.backend.gpds.main.repository.jpa.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    public RefreshToken verifyExpiration(RefreshToken token) {
        if (token.getExpiryDate().compareTo(Instant.now()) < 0) {
            ...
            throw new BusinessRuleViolationException("Refresh token was expired. Please make a new signin request");
        }
        return token;
    }
